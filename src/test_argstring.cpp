...
#define F(...) {    \
    cout << '(' << #__VA_ARGS__ << ") = (" << cubs::toStringWithDefault(__VA_ARGS__) << ')' << endl; \
}
...
class ArgStringTest : public CppUnit::TestFixture
{
    CPPUNIT_TEST_SUITE(ArgStringTest);
    CPPUNIT_TEST(check);
...
CPPUNIT_TEST_SUITE_REGISTRATION(ArgStringTest);
